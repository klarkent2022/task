...
export default function DetailsScreen({}) {
    return (
        <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center', backgroundColor: "#fff"}}>
            ...
            <Text style={{ position: "absolute", top: 260, fontSize: 20 }}> 스템커피 코엑스점 </Text>
            <Text style={{ fontSize: 15,  color: "grey", position: "absolute", top: 320, left: 130  }}> 커피 샵 </Text>
            <Text style={{ fontSize: 15,  color: "grey", position: "absolute", top: 320, left: 220  }}>별점 2.5</Text>
        ...
        flexWrap: 'wrap'}}> 서울특별시 강동구 양재대로 128길 14 (길동) 서울, 05302 </Text>
            ...
            <Text style={{ fontSize: 15,  color: "#727272", position: "absolute", top: 470, left: 150  }}> 10:00 - 23:59 </Text>
